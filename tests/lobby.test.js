...
before(() => {
  ...
  const jsFiles = [
    ...
    path.join(publicDir, 'js', 'storage', 'MutePreferenceStore.js'),
    ...
    path.join(publicDir, 'js', 'thousand', 'TrumpBox.js'),
    ...
    path.join(publicDir, 'js', 'thousand', 'SoundManager.js'),
    path.join(publicDir, 'js', 'thousand', 'MuteButton.js'),
